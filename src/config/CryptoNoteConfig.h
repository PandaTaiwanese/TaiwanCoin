...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x379e;
...
const char     CRYPTONOTE_NAME[]                             = "TaiwanCoin";
...
const int      P2P_DEFAULT_PORT                              =  10103;
const int      RPC_DEFAULT_PORT                              =  10104;
